package br.ufmg.engsoft.reprova.database.repositories;
...
import br.ufmg.engsoft.reprova.database.connections.Mongo;
...
/**
 * Repository for Question class on mongodb.
 */
public class QuestionRepository implements IQuestionRepository{
   ...
   * Logger instance.
   */
  protected static final Logger logger = LoggerFactory.getLogger(QuestionRepository.class);
